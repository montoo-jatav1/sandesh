...
import com.sandeshx.services.AdminPasswordRequiredException
    ...
    route("/api/auth") {
        post("/otp/send") {
            ...
            try {
                ...
                call.respond(
                    HttpStatusCode.OK,
                    SendOtpResponse(message = "OTP sent", requiresPassword = AuthService.requiresAdminPassword(req.phoneNumber))
                )
        ...
        post("/otp/verify") {
            ...
            try {
                val result = AuthService.verifyOtpAndLogin(req.phoneNumber, req.code, req.password)
                call.respond(
                    HttpStatusCode.OK,
                ...
                call.respond(HttpStatusCode.TooManyRequests, ErrorResponse(e.message ?: "Rate limited"))
            } catch (e: AdminPasswordRequiredException) {
                call.respond(HttpStatusCode.Unauthorized, ErrorResponse(e.message ?: "Password required"))
            }
        }
